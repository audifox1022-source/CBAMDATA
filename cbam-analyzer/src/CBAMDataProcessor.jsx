...
// 라이브러리 로드
// Vercel 배포 시에는 package.json 의존성을 사용합니다. Canvas 내 실행을 위해 CDN 로드는 유지합니다.
...
2025-01-03,2025-02-14,"H1,OS,P8,R9,TW",P8,황지,주간조,241108-15207-001,1,1,1,4084,4084,내셔날오일웰바르코코리아유한회사,조선,황삭,FORGING,RING,"2,286.00*2,041.00*494.00",19106582-DAD R.01,S355J2G3,CARBON,태웅-B-800 (CARBON),R/B,4084
2025-01-04,2025-04-03,"OS,P5,R9,TW,P15",R9,단조제품,야간조,240924-19661-031,2,2,2,0,10515,28903716,HAIZEA WIND,풍력,정삭,5258,TOWER FLANGE,RING,"3,600.00*3,250.00*195.00",703712280 Rev.-,AISI4140,ALLOY,태웅-B-500 (ALLOY),R/B,10515
...
2025-01-02,2025-01-20,"OS,P5,R9,TW",P5,단조제품,주간조,241008-19004-002,1,2,2,0,7360,14720,M.H.I,산업기계,정삭,3680,END RING,RING,"2,400.00*1,680.00*355.00",J01-50346 Rev.0 #2,A266Gr1,CARBON,NSC-S-300(CARBON),SLAB,7360
2025-02-01,2025-05-09,"H1,OS,R9,TW",R9,황지,주간조,241028-17029-002,1,1,1,1000,1000,현대삼호 주식회사,산업기계,정삭,WHEEL,DISC,"800.00*180.00*185.00",T1-CN-1E101,SSW Q3R,SUS,태웅-B-600 (SUS),R/B,1000
`;
...
const App = () => {
    ...
    const getFlattenedDataForDownload = useCallback(() => {
        ...
        excelData.push([
            "", "총합계", "", 
            grandTotals.carbon.ic, grandTotals.carbon.vsd, grandTotals.carbon.cc, grandTotals.carbon.rb, grandTotals.carbon.slab, 
            grandTotals.alloy.ic, grandTotals.alloy.vsd, grandTotals.alloy.cc, grandTotals.alloy.rb, grandTotals.alloy.slab,
            grandTotals.sus.ic, grandTotals.sus.rb, grandTotals.sus.slab,
            grandTotals.tool.ic, grandTotals.tool.slab 
        ]);
